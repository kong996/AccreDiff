...
class MeltScalingModel:
    ...
    def __init__(self, Mtotal=2.0, gamma=0.5, vel=2.0, entropy0=1100, impact_angle=90):
        ...
        self.wisdom_dir = os.path.dirname(os.path.abspath(__file__)) # directory of this file
        self.entropyfile = os.path.join(self.wisdom_dir, f"data/rho_u_S{self.entropy0}.dat") 
    ...
    def run_model(self):
        ...
        parameter_file = os.path.join(self.wisdom_dir, 'data/parameter.txt')
        parameter_list = [line.split() for line in open(parameter_file)]
        ...
        error_file = os.path.join(self.wisdom_dir, 'data/Model_sigma.txt')
        error_read = [line.split() for line in open(error_file)]
        ...
        # -- reading coefficients from ./data/coef.txt
        # Heat distribution model within mantle. See equation 13 and Table S.7
        coef_file = os.path.join(self.wisdom_dir, 'data/coef.txt')
        coef_read = [line.split() for line in open(coef_file)]
